...
RATING = {
    ...
    "число отзывов": "44",
    "годы опыта": "1",
    # 20.09.2026 фид отвалился второй раз: не хватало «конверсии». По документации
    # Вебмастера это не процент, а произвольный вес ранжирования внутри сета,
    # «чем больше, тем лучше». Ставим всем одинаково: приоритет предложений
    # не задан, а выдумывать разницу без решения Дениса нельзя.
    "конверсия": "1",
}
