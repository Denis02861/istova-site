        ...
        <section className="bg-brand text-sand">
          <div className="container mx-auto px-6 max-w-3xl py-20 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <TrackedLink
                goal="BOOKING_CLICK" goalParams={{ from: "rasslablyayushchiy_massazh_cta" }} href="/go/zapis/?from=page_rasslablyayushchiy" rel="nofollow"
              ...
              <TrackedLink
                goal="TG_CLICK" goalParams={{ from: "rasslablyayushchiy_massazh_cta" }} href="https://t.me/Istova_spa"
