...
const DESCRIPTION =
  "Истова — спа-пространство 256 м² на Васильевском острове. Что значит название, почему мы занимаемся спа для головы, как устроены кабинеты и кто работает с гостями.";
        ...
        <section className="bg-brand text-sand">
          <div className="container mx-auto px-6 max-w-3xl py-20 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <TrackedLink
                goal="BOOKING_CLICK" goalParams={{ from: "onas_cta" }} href="/#booking"
