    ...
    <>
      ...
      <main className="bg-sand">
        <LandingHero
          ...
          title="Антистресс-ритуалы в Санкт-Петербурге"
          lead="Когда напряжение копилось неделями, а не один тяжёлый день. Ритуалы для тела, головы и шеи, тёплая вода и тишина, в которой можно наконец ничего не решать."
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <SplitBlock
            ...
            photo="/gallery/2026-09/kompress-litso.webp"
            photoAlt="Тёплый компресс в финале ритуала"
          />
        ...
        <section className="bg-brand text-sand">
          <div className="container mx-auto px-6 max-w-3xl py-20 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <TrackedLink
                goal="BOOKING_CLICK" goalParams={{ from: "antistress_cta" }} href="/go/zapis/?from=page_antistress" rel="nofollow"
              ...
              <TrackedLink
                goal="TG_CLICK" goalParams={{ from: "antistress_cta" }} href="https://t.me/Istova_spa"
