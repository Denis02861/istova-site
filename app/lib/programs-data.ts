...
export const programs: Program[] = [
  // ─── БАЗОВЫЕ ПАРНЫЕ ───
  {
    ...
    dur: "100 мин",
    price: "9 200 ₽",
    teaser: "Утренний ритуал: сауна с бодрящими эфирами, пилинг с солью, тонизирующий СПА-массаж, уход за лицом.",
    cosmetics: [
  ...
  },
  {
    ...
    dur: "70 мин",
    price: "6 800 ₽",
    teaser: "Знакомство со спа за 70 минут: массаж, уход за лицом, Золотая дуга.",
    cosmetics: [
