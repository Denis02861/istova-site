    ...
    <>
      ...
      <main className="bg-sand">
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <PhotoStrip
            photo="/gallery/frag-lounge.webp"
          ...
          <SplitBlock
            ...
            photo="/gallery/2026-09/guasha-litso.webp"
            photoAlt="Массаж лица пластинами гуаша"
          />
        ...
        <section className="bg-brand text-sand">
          <div className="container mx-auto px-6 max-w-3xl py-20 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <TrackedLink
                goal="BOOKING_CLICK" goalParams={{ from: "kak_prohodit_cta" }} href="/go/zapis/?from=page_kak_prohodit" rel="nofollow"
