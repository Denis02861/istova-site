...
const DESCRIPTION =
  "9 авторских спа-ритуалов Истовы на Васильевском острове: утренние и вечерние программы, мужские и женские, бережная — для беременных, знакомство и ритуал тишины.";
