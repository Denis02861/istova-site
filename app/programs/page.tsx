...
const DESCRIPTION =
  "9 авторских спа-ритуалов Истовы и спа для двоих на Васильевском острове: утренние и вечерние программы, мужская и женская, для беременных, знакомство, ритуал тишины.";
