...
const SHORT_DESC: Record<string, string> = {
  ...
  "lada":
    "Женский спа-ритуал восстановления 2 ч 30 мин: финская сауна, турецкий пилинг кесе, тёплые травяные мешочки, массаж лица гуаша, Золотая дуга, финал с маслом нероли.",
  "rodnik":
    "Спа для беременных в СПб — бережный 90-минутный ритуал для будущей мамы. Со 2 триместра и через 6 недель после родов. Уход за лицом, лимфодренаж, ритуал лёгких ног.",
};
