...
const SHORT_DESC: Record<string, string> = {
  "zarya-telo":
    "Утренний ритуал через тело: финская сауна, пилинг с гималайской солью, тонизирующий массаж 45 мин, уход за лицом.",
  "zarya-volosy":
    "Утреннее спа для головы: массаж с криосферами, «Золотая дуга», уход Davines, пенный массаж головы.",
  "sumerki-telo":
    "Вечерний ритуал: сауна с лавандой, кремовый пилинг, обёртывание, спа-массаж 45 мин, согревание кистей и стоп.",
  "sumerki-volosy":
    "Вечернее спа для головы: расслабляющий массаж лица, травяной ритуал, «Золотая дуга», уход Davines.",
  "kedr-lada":
    "Спа для двоих: ей ЛАДА, ему КЕДР — одновременно, каждый со своим мастером. Цена за двоих.",
  "yav":
    "Знакомство с Истовой: массаж спины и плеч, массаж головы, уход за лицом, «Золотая дуга», Davines.",
  "kedr":
    "Мужской ритуал силы: хвойная сауна, кедровый пилинг, бамбук, массаж тёплыми камнями 60 мин, спа для головы.",
  "lada":
    "Женский спа-ритуал: финская сауна, турецкий пилинг кесе, массаж тела 45 мин, гуаша для лица, спа для головы.",
  "rodnik":
    "Бережный ритуал без нагрузки: массаж лица, спа для головы с «Золотой дугой», уход Davines, ритуал лёгкости для ног.",
};
...
const SEO_SUFFIX: Record<string, string> = {
  ...
  "sumerki-volosy": "head spa и спа для волос в СПб",
