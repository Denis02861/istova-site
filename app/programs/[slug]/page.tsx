...
const SHORT_DESC: Record<string, string> = {
  ...
  "zarya-volosy":
    "Утренний ритуал для кожи головы: выбор аромата, тонизирующий массаж с криосферами, пенный СПА-массаж, Золотая дуга, Davines, звучание чаши.",
  "sumerki-telo":
    "Вечерний ритуал расслабления через тело: выбор аромата, сауна с лавандой, сандаловое обёртывание, СПА-массаж 45 мин, паровая маска, чаша.",
  "sumerki-volosy":
    "Вечерний ритуал для кожи головы: выбор аромата, массаж с нефритовыми роликами, травяной настой, Золотая дуга, Davines, звучание чаши.",
  "otzvuk":
    "Ритуал глубокой тишины (120 мин): ритуал встречи через дыхание, аудиопогружение в объёмном звуке, сенсорный уход для лица, заземление через стопы, ритуал веса, финал под тяжёлым одеялом. Без водных практик.",
  "yav":
  ...
  "kedr":
    "Мужской спа-ритуал (150 мин): выбор аромата кедра/можжевельника/сосны, финская сауна, креольский массаж бамбуком, горячие камни 60 мин, уход за лицом и бородой с охлаждающей маской, звучание чаши.",
  "lada":
  ...
  "rodnik":
    "Спа для беременных в СПб (90 мин): ритуал спокойного дыхания, мягкий массаж лица с нефритом, СПА-уход, ритуал лёгких ног с лимфодренажем, мягкий массаж кистей, мягкое звучание чаши. Со 2 триместра.",
};
