...
const SHORT_DESC: Record<string, string> = {
  ...
  "otzvuk":
    "2-часовой ритуал глубокой тишины без водных практик. Аудиопогружение, sound bath с поющими чашами, сенсорный уход для лица, ритуалы заземления, финал под тяжёлым одеялом.",
  "yav":
  ...
  "lada":
    "Женский ритуал восстановления 2 ч 30 мин: финская сауна, турецкий пилинг кесе, тёплые травяные мешочки, эстетический массаж лица гуаша, Золотая дуга, финал с маслом нероли.",
  "rodnik":
    "Бережный 90-минутный ритуал для будущей мамы. Со 2 триместра и через 6 недель после родов. Уход за лицом, лимфодренаж, ритуал лёгких ног.",
};
