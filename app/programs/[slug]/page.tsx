...
const SHORT_DESC: Record<string, string> = {
  ...
  "potok":
    "Авторский Japanese head spa на Золотой дуге: 90 минут непрерывного потока тёплой воды на кожу головы, скраб и глубокая маска Davines.",
  "otzvuk":
    "Двухчасовой ритуал глубокой тишины: ASMR-уход для лица в бинауральных наушниках, sound bath с поющими чашами на теле, Золотая дуга в полной тишине.",
  "yav":
    "Двухчасовая флагманская программа знакомства с Истовой: финская сауна, СПА-массаж задней поверхности тела, уход за лицом, Золотая дуга и СПА-уход Davines.",
  "kedr":
    "Мужской ритуал восстановления, 2 ч 30 мин: финская сауна с кедровыми эфирами, креольский массаж бамбуковыми палочками, массаж с горячими камнями, уход Davines для лица и бороды.",
  "rodnik":
