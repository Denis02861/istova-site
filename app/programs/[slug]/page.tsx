...
const SHORT_DESC: Record<string, string> = {
  "zarya-telo":
    "Утренний ритуал пробуждения через тело: финская сауна с бодрящими эфирами, пилинг с гималайской солью, тонизирующий массаж и пробуждение через стопы.",
  "zarya-volosy":
    "Утренний ритуал для кожи головы: тонизирующий массаж с криосферами, пенный СПА-массаж, Золотая дуга и СПА-уход Davines.",
  "sumerki-telo":
    "Вечерний ритуал расслабления через тело: сауна с успокаивающими эфирами, лавандовый пилинг, сандаловое обёртывание, расслабляющий массаж.",
  "sumerki-volosy":
    "Вечерний ритуал расслабления через кожу головы: тёплый травяной настой, Золотая дуга, СПА-уход Davines и расслабляющий массаж головы.",
  "otzvuk":
    "Ритуал глубокой тишины: sound bath, ASMR-аудиопогружение, сенсорный уход для лица, ритуалы заземления, финал под тяжёлым одеялом. Без водных практик.",
  "yav":
    "Ритуал знакомства с Истовой: расслабляющий массаж спины и шейно-воротниковой зоны, освежающий уход за лицом, Золотая дуга, СПА-уход Davines.",
  "kedr":
    "Мужской спа-ритуал восстановления, спа для мужчин: финская сауна, креольский массаж бамбуковыми палочками, горячие камни, уход за лицом и бородой.",
  "lada":
    "Женский спа-ритуал восстановления: финская сауна, турецкий пилинг кесе, тёплые травяные мешочки, массаж лица гуаша, Золотая дуга, финал с маслом нероли.",
  "rodnik":
    "Спа для беременных в СПб — бережный ритуал для будущей мамы. Со 2 триместра и через 6 недель после родов. Уход за лицом, лимфодренаж, ритуал лёгких ног.",
};
