...
const FAQ = [
  ...
  {
    q: "Что такое массаж головы водой?",
    a: "Это массаж, который мастер делает под тёплой проточной водой: голова лежит в специальной раковине, вода идёт мягким рассеянным потоком через изогнутую трубку. Вода убирает трение, поэтому движения мягче и глубже, чем при сухом массаже, а кожа головы прогревается равномерно. В Истове эта часть занимает около сорока минут и входит во все программы для головы.",
  },
  {
...
export const metadata: Metadata = {
  ...
  keywords: ["массаж головы спб", "спа массаж головы спб", "массаж головы в спб", "расслабляющий массаж головы спб", "массаж кожи головы", "массаж головы водой спб", "массаж головы водой", "Истова"],
      ...
      <main className="bg-sand">
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <SplitBlock
            ...
            photo="/gallery/2026-09/pena-golova.webp"
            photoAlt="Пенный массаж кожи головы"
          />

          <SplitBlock
            title="Массаж головы водой: как это устроено"
            flip
            paragraphs={[
              "Вы лежите, голова на подголовнике специальной раковины, шея не висит и не напрягается. Сверху идёт тёплая вода: не струёй из душа, а мягким рассеянным потоком через изогнутую трубку, которую у нас называют золотой дугой. Вода тёплая, около температуры тела, и первые минуты уходят просто на то, чтобы к ней привыкнуть.",
              "Дальше мастер работает руками прямо под водой. Это и есть главное отличие от сухого массажа: вода снимает трение, движения становятся мягче и глубже, а кожа головы прогревается равномерно. Плюс постоянный тёплый шум над ушами, от которого мысли сами собой замедляются.",
              "Занимает эта часть около сорока минут и входит во все программы с головой. После неё волосы промывают, наносят уход Davines и в финале сушат и укладывают, так что выходить на улицу можно сразу.",
            ]}
            photo="/gallery/2026-09/duga-voda-krupno.webp"
            photoAlt="Массаж головы водой через золотую дугу"
          />
          ...
          <PhotoStrip
            photo="/gallery/2026-09/duga-kabinet.webp"
            alt="Кабинет спа для головы с золотой дугой"
          ...
          <SplitBlock
            ...
            photo="/gallery/2026-09/massazh-litsa.webp"
            photoAlt="Работа мастера с лицом и шеей"
          />
        ...
        <section className="bg-brand text-sand">
          <div className="container mx-auto px-6 max-w-3xl py-20 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <TrackedLink
                goal="TG_CLICK" goalParams={{ from: "massazh_golovy_cta" }} href="https://t.me/Istova_spa"
