    ...
    <section id="programs" className="py-16 md:py-24 bg-sand-deep/30 overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <p className="text-center text-brand-dark/70 mb-10 max-w-2xl mx-auto">
          8 авторских ритуалов Истовы, у каждого свой темп, аромат и финал. Почти каждый можно
          пройти вдвоём в смежных кабинетах:{" "}
          {/* Контекстная ссылка с точным анкором. Раньше на страницу вели только
              меню и подвал, из-за чего Яндекс по запросу «спа для двоих» показывал
              главную, а сама страница стояла на 96 месте. */}
          <a href="/spa-dlya-dvoih/" className="underline underline-offset-2 decoration-brand/30 hover:decoration-brand">
            спа для двоих в СПб
          </a>
          . Свайпайте карточки →
        </p>
