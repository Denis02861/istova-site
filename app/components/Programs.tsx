...
const programs: Program[] = [
  ...
  },
  {
    ...
    steps: [
      "Беспроводные наушники с бинауральной записью (шёпот, шорохи, тёплые звуки)",
      "ASMR-уход за лицом (тихие техники, кисти, лёгкое постукивание, параллельно звук в наушниках)",
      "Sound bath — поющие чаши на теле (грудина, живот, бёдра, стопы; длинные вибрации, 20 минут)",
      "Звук гонга и тибетская мантра в наушниках",
      "Золотая дуга в полной тишине (только поток воды)",
      "Утяжелённое одеяло с гречкой (10 минут под одеялом, приглушённый свет)",
    ],
    dur: "2 ч",
    price: "13 000 ₽",
  },
  {
    ...
    name: "ЯВЬ",
    category: "special",
    accent: "ДЕНЬ · Ритуал знакомства с Истовой",
    steps: [
      "Финская сауна с эфирами по арома-выбору",
      "Соляной скраб тела (морская соль + лёгкое масло)",
      "СПА-массаж задней поверхности тела, 25 мин (тёплое масло, средний темп)",
      "Освежающий уход для лица",
      "Пенный массаж кожи головы",
      "Золотая дуга — авторский аква-ритуал",
      "СПА-уход Davines (очищение, восстановление, мягкость)",
    ],
    after: "Сушка и лёгкая укладка",
    dur: "2 ч",
    price: "10 500 ₽",
