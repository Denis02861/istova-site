...
export default function StickyMobileBar() {
  ...
  return (
    <div
      ...
      className={`md:hidden fixed left-0 right-0 bottom-0 z-40 bg-sand/95 backdrop-blur-md border-t border-brand/15 shadow-[0_-2px_20px_rgba(116,68,54,0.08)] transition-all duration-500 ease-out ${show ? "translate-y-0 opacity-100" : "translate-y-full opacity-0 pointer-events-none"}`}
      style={{ paddingBottom: "env(safe-area-inset-bottom)" }}
    >
      <div className="grid grid-cols-4 divide-x divide-brand/10">
        <TrackedLink
          goal="PHONE_CLICK"
        ...
        <a
          ...
          className="py-3 text-center text-[11px] uppercase tracking-widest text-sand bg-brand active:bg-brand-dark"
