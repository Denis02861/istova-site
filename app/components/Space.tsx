  ...
  return (
    <section id="space" className="py-24 bg-sand">
      <div className="container mx-auto px-6 max-w-5xl">
        <h2 className="font-display text-4xl md:text-5xl text-brand mb-6 text-center uppercase tracking-wider">Два мира под одной крышей</h2>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[1,2,3,4,5,6].map(i => (
            <div key={i} className="aspect-[4/5] bg-sand-deep flex items-center justify-center text-brand/30 font-display text-2xl">
              фото {i}
            </div>
          ))}
        </div>
