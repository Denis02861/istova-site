...
const steps = [
  ...
  { n: "05", t: "Возвращение", d: "Приглушённый свет, тишина, неспешность. Возвращаемся в мир медленно." },
];
...
export default function Ritual() {
  ...
  const spiralScale = useTransform(scrollYProgress, [0, 0.9], [1, 0.25]);
  ...
  return (
    <section ref={sectionRef} id="ritual" className="py-16 md:py-24 bg-sand relative overflow-hidden">
      ...
      <motion.img
        ...
        className="absolute top-4 left-[-24px] md:top-8 md:left-[-40px] w-40 md:w-[380px] pointer-events-none will-change-transform"
