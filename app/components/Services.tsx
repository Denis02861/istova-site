...
const services = [
  { src: "/gallery/01-nastroyka.webp", title: "Настройка", desc: "Первые минуты, чтобы сбавить темп и настроиться." },
  { src: "/gallery/02-spa-zone.webp",  title: "Спа-зона",  desc: "Ритуалы для головы и тела, чтобы как следует отдохнуть." },
  { src: "/gallery/03-sauna.webp",     title: "Финская сауна", desc: "70-90°C — расслабление мышц и снятие напряжения. Дополняет уходы за телом." },
  { src: "/gallery/04-head-spa.webp",  title: "Спа головы", desc: "Азиатская техника и аква-медитация с водной дугой. Авторские программы Истовы." },
  { src: "/gallery/05-massage.webp",   title: "Массаж",     desc: "Мастера владеют техниками расслабляющего массажа. Работают мягко и без спешки." },
  { src: "/gallery/06-body.webp",      title: "Для тела",   desc: "Деликатное скрабирование натуральными скрабами, тёплые обёртывания." },
];
