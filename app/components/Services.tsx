...
const services = [
  { src: "/services/01-nastroyka.jpg", title: "Настройка", desc: "Первые минуты, чтобы сбавить темп и настроиться." },
  { src: "/services/02-spa-zone.jpg",  title: "Спа-зона",  desc: "Ритуалы для головы и тела, чтобы как следует отдохнуть." },
  ...
  { src: "/services/05-massage.jpg",   title: "Массаж",     desc: "Мастера владеют техниками расслабляющего массажа. Работают мягко и без спешки." },
