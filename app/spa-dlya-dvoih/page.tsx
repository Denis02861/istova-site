...
const TITLE = "Спа для двоих в СПб — цены от 12 000 ₽ за двоих · Истова";
const DESCRIPTION =
  "Спа для двоих в Санкт-Петербурге: парные ритуалы для тела и кожи головы, свой мастер у каждого. Цены на двоих от 12 000 до 21 000 ₽, м. Приморская.";
