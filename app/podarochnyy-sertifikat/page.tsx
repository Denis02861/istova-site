      ...
      <main className="bg-sand">
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <SplitBlock
            ...
            photo="/gallery/2026-09/sertifikat-v-rukah.webp"
            photoAlt="Подарочный сертификат Истовы в конверте"
          />
          ...
          <SplitBlock
            ...
            photo="/gallery/2026-09/sertifikat-svet.webp"
            photoAlt="Подарочный сертификат Истовы в интерьере салона"
          />
